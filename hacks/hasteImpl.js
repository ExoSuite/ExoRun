...
const pluginNameReducers /*: Array<[RegExp, string]> */ = haste.platforms.map(name => [
  new RegExp(`^(.*)\\.(${name})$`),
  "$1",
])
...
const WHITELISTED_PREFIXES /*: Array<string> */ = ["IntegrationTests", "Libraries", "ReactAndroid", "RNTester"]
